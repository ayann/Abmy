...
public class Assets implements Disposable, AssetErrorListener {
    ...
    public class TetroBlock {
        ...
        public TetroBlock(TextureAtlas atlas) {
    ...
    public void init(AssetManager assetManager) {
        ...
        // load texture atlas
        assetManager.load(TetrisGame.TEXTURE_ATLAS_OBJECTS, TextureAtlas.class);
        ...
        TextureAtlas atlas = assetManager.get(TetrisGame.TEXTURE_ATLAS_OBJECTS);
        ...
        tetromino = new TetroBlock(atlas);
